package com.woodnsoft.airmajor_bs_android.bsHandax.DataListView.Dialog_item_spec;
...
public class Dialog_item_spec_View extends LinearLayout  {
	...
	public Dialog_item_spec_View(Context context, Dialog_item_spec_Item aItem) {
		...
		// Set Text
		itv_maker_code      = (TextView) findViewById(R.id.tv_maker_code);        itv_maker_code.setText(aItem.getData(0));       //00:¸ÞÀÌÄ¿ÄÚµå
		itv_item_spec       = (TextView) findViewById(R.id.tv_item_spec);         itv_item_spec.setText(aItem.getData(1));        //01:±Ô°Ý
	}
