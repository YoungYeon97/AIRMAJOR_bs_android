...
public class Dialog_Line_View extends LinearLayout  {
	...
	public Dialog_Line_View(Context context, Dialog_Line_Item aItem) {
		...
		// Set Text
		itv_line_name        = (TextView) findViewById(R.id.tv_line_name);        itv_line_name.setText(aItem.getData(0));        //00:¸ÞÀÌÄ¿ÄÚµå
		itv_line_name.setText(aItem.getData(1));        //01:¸ÞÀÌÄ¿¸í
	}
