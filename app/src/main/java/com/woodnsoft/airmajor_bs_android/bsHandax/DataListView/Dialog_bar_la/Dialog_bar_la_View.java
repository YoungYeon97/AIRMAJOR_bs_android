...
public class Dialog_bar_la_View extends LinearLayout  {
	...
	public Dialog_bar_la_View(Context context, Dialog_bar_la_Item aItem) {
		...
		// Set Text
		itv_bar_la_name        = (TextView) findViewById(R.id.tv_bar_la_name);        itv_bar_la_name.setText(aItem.getData(0));        //00:Á¦Ç°±¸ºÐ
		itv_bar_la_name.setText(aItem.getData(1));        //01:Á¦Ç°±¸ºÐ¸í
	}
