...
public class Dialog_Jata_View extends LinearLayout  {
	...
	public Dialog_Jata_View(Context context, Dialog_Jata_Item aItem) {
		...
		// Set Text
		itv_jata_flag_name        = (TextView) findViewById(R.id.tv_jata_flag_name);        itv_jata_flag_name.setText(aItem.getData(0));        //00:磊鸥备盒内靛
		itv_jata_flag_name.setText(aItem.getData(1));        //01:磊鸥备盒疙
	}
